...
function Card() {
    return (
      <div className="bg-dark-gray text-white p-8">
        <div className="ml-14 mt-14 border border-white w-[357px] rounded-lg">
            <img className="rounded-lg" src="https://csyxkpbavpcrhwqhcpyy.supabase.co/storage/v1/object/public/assets/property-challenge/thumbnail-1.jpg" alt="" />
            <div className="p-5">
              <h1 className="font-bold">Nordic Retreat with Stunning Views</h1>
              <p className="text-sm font-semibold mt-2 text-gray-500">Immerse yourself in the beauty of the Nordic landscape at this sleek and stylish cabin. With floor-to-ceiling windows and a spacious deck, you'll have breathtaking views of the surrounding mountains.</p>
              ...
              <div className="flex flex-row py-4">
                ...
                <p className="text-xs my-1.5 ml-1">2 bedrooms</p>
                ...
                <p className="text-xs my-1.5 ml-1">3 guests</p>
              </div>
              ...
              <div className="flex justify-between my-3">
                  ...
                  <div className="flex items-center">
                      ...
                      <p className="mx-1 font-semibold text-sm mt-0.5">4.9</p>
                  </div>
              </div>
            </div>
        </div>
